...
function marsExploration(s) {
    // find how many "sos"'s were recieved
    let receivedSignal = s.length/3;
    // create the expected signal pattern
    let expectedSignal = "SOS".repeat(receivedSignal);
    // count the errors
    let errors = 0;
    // iterate over the recieved comparing to the expected
